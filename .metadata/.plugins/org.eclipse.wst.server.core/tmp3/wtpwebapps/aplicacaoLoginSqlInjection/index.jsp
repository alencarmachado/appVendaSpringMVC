 ...
 -->
	...
	<fieldset>
			<div class="form-group">			
				...
				<input type="text" name="login" id="login" autofocus="autofocus" placeholder="login" class="form-control" required /> <br />
			</div>
			<div class="form-group">			
				<label for="senha">Senha</label>		
				<input type="password" name="senha" id="senha" placeholder="senha" class="form-control" required/><br />	
			</div>
